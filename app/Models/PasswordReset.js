...
class PasswordReset extends Model {
    static boot(){
        ...
        this.addHook('beforeCreate', async model => {                       //sera criado o token antes de ser registrado no banco de dados
            ...
            const expires_at = new Date() // aqui expire_at esta recebendo uma nova data para  expiracão do token

            expires_at.setMinutes(expires_at.getMinutes() +30)  //o expires_at vai pegar a hora atual e vai colocar mais 30 minutos para a expiracão do token
